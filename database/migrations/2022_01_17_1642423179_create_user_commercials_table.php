...
class CreateUserCommercialsTable extends Migration {
	/**
	 * Run the migrations.
	 *
	 * @return void
	 */
	public function up() {
		Schema::create('user_commercials', function (Blueprint $table) {
				$table->bigIncrements('id');
				$table->string('commercial_id');
				$table->string('commercial_file');
				$table->date('commercial_end_at');
	...
	public function down() {
		Schema::dropIfExists('user_commercials');
	}
}