...
class SupportMessagesDataTable extends DataTable
{
    ...
    public function dataTable(DataTables $dataTables, $query)
    {
        return datatables($query)
            ->addColumn('actions', 'admin.supportmessages.buttons.actions')
            ->addColumn('department_id', '{{ $department["department_name_ar"] }}')
    ...
    {
        return SupportMessage::query()->select("support_messages.*");
    	...
    	public function html()
	    {
	      $html =  $this->builder()
            ...
            ". filterElement('2', 'select', [
				...
				...\App\Models\Department::all()->pluck('department_name_ar')
            ]) . "
