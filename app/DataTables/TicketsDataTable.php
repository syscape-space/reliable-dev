...
class TicketsDataTable extends DataTable {
	...
	public function dataTable(DataTables $dataTables, $query) {
		return datatables($query)
			...
			->addColumn('ticket_linked', '{{ trans("admin.".$ticket_linked) }}')
			->addColumn('ticket_status', '{{ trans("admin.".$ticket_status) }}')
			->addColumn('user_ticket_rate', '{{ trans("admin.".$user_ticket_rate) }}')
	...
	public function query() {
		return Ticket::query()->with(['user_id', 'ticket_department_id'])->select("tickets.*");
	...
	public function html() {
		...
		//->ajax('')
            ...
            ".filterElement('1,2,4,5', 'input')."
             ...
             ".filterElement('7', 'select', \App\Models\TicketDepartment::pluck(l('department_name'), l('department_name')))."

             ".filterElement('3', 'select', [
						'order'          => trans('admin.order'),
						'offer'          => trans('admin.offer'),
						'charge'         => trans('admin.charge'),
						'received_money' => trans('admin.received_money'),
	...
	protected function getColumns() {
		return [
			...
			[
				'name'  => 'ticket_title',
				'data'  => 'ticket_title',
				'title' => trans('admin.ticket_title'),
			],
			[
				'name'  => 'tickets.ticket_linked',
				'data'  => 'ticket_linked',
				'title' => trans('admin.ticket_linked'),
			],
			[
				'name'  => 'link_id',
				'data'  => 'link_id',
				'title' => trans('admin.link_id'),
			],
			[
				'name'  => 'user_id.name',
				'data'  => 'user_id.name',
			...
			[
				'name'  => 'tickets.ticket_status',
				'data'  => 'ticket_status',
				'title' => trans('admin.ticket_status'),
			],
			[
				'name'  => 'ticket_department_id.department_name_ar',
				'data'  => 'ticket_department_id.department_name_ar',
				'title' => trans('admin.ticket_department_id'),
			],
			[
				'name'       => 'created_at',
				'data'       => 'created_at',
