...
class SocialsDataTable extends DataTable {
	...
	public function dataTable(DataTables $dataTables, $query) {
		return datatables($query)
			...
			->addColumn('social_icon', '{!! view("admin.show_image",["image"=>$social_icon])->render() !!}')
			->addColumn('social_fa', '<i class="{{ $social_fa }}"></i>')
			->addColumn('created_at', '{{ date("Y-m-d H:i:s",strtotime($created_at)) }}')	->addColumn('updated_at', '{{ date("Y-m-d H:i:s",strtotime($updated_at)) }}')	->addColumn('checkbox', '<div  class="icheck-danger">
                  <input type="checkbox" class="selected_data" name="selected_data[]" id="selectdata{{ $id }}" value="{{ $id }}" >
                  <label for="selectdata{{ $id }}"></label>
                </div>')
			->rawColumns(['checkbox', 'actions', "social_icon", "social_fa"]);
	}
	...
	protected function getColumns() {
		return [
			...
			[
				'name'  => 'social_name',
				'data'  => 'social_name',
				'title' => trans('admin.social_name'),
			],
			[
				'name'  => 'social_fa',
				'data'  => 'social_fa',
				'title' => trans('admin.social_fa'),
			],
			[
				'name'  => 'social_icon',
				'data'  => 'social_icon',
				'title' => trans('admin.social_icon'),
			],
			[
				'name'  => 'social_url',
				'data'  => 'social_url',
				'title' => trans('admin.social_url'),
			],
			[
				'name'       => 'created_at',
				'data'       => 'created_at',
