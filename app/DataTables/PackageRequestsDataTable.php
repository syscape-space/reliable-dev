...
class PackageRequestsDataTable extends DataTable {
	...
	public function dataTable(DataTables $dataTables, $query) {
		return datatables($query)
			->addColumn('actions', 'admin.packagerequests.buttons.actions')
			->addColumn('request_status', '{{ trans("admin.".$request_status) }}')
			->addColumn('suspended_balance', '{{ trans("admin.".$suspended_balance) }}')
			->addColumn('invoiced', '{{ trans("admin.".$invoiced) }}')
	...
	public function query() {
		return PackageRequest::query()->with(['package_id', 'user_id'])->select("package_requests.*");
	...
	protected function getColumns() {
		return [
			...
			[
				'name'  => 'package_id.package_title',
				'data'  => 'package_id.package_title',
				'title' => trans('admin.package_id'),
			],
			[
				'name'  => 'user_id.name',
				'data'  => 'user_id.name',
			...
			[
				'name'  => 'package_requests.request_status',
				'data'  => 'request_status',
				'title' => trans('admin.request_status'),
			],
			[
				'name'  => 'package_requests.suspended_balance',
				'data'  => 'suspended_balance',
				'title' => trans('admin.suspended_balance'),
			],
			[
				'name'       => 'created_at',
				'data'       => 'created_at',
