...
class UserQualificationsDataTable extends DataTable {
	...
	public function dataTable(DataTables $dataTables, $query) {
		return datatables($query)
			->addColumn('actions', 'admin.userqualifications.buttons.actions')
			->addColumn('qualification_file', '{!! view("admin.show_image",["image"=>$qualification_file])->render() !!}')
			->addColumn('created_at', '{{ date("Y-m-d H:i:s",strtotime($created_at)) }}')	->addColumn('updated_at', '{{ date("Y-m-d H:i:s",strtotime($updated_at)) }}')	->addColumn('checkbox', '<div  class="icheck-danger">
                  <input type="checkbox" class="selected_data" name="selected_data[]" id="selectdata{{ $id }}" value="{{ $id }}" >
                  <label for="selectdata{{ $id }}"></label>
                </div>')
			->rawColumns(['checkbox', 'actions', "qualification_file"]);
	}
	...
	public function query() {
		return UserQualification::query()->with(['user_id',
				'user_job_id',
				'occupation_id',
				'specialtie_id'])->select("user_qualifications.*");
	...
	protected function getColumns() {
		return [
			...
			[
				...
				'title' => trans('admin.qualification_name'),
			],
			[
				'name'  => 'qualification_file',
				'data'  => 'qualification_file',
				'title' => trans('admin.qualification_file'),
			],
			[
				'name'  => 'user_id.name',
				'data'  => 'user_id.name',
	...
	protected function filename() {
		return 'userqualifications_'.time();
	}
