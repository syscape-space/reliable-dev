...
class UserJobsDataTable extends DataTable {
	...
	public function dataTable(DataTables $dataTables, $query) {
		return datatables($query)
			->addColumn('actions', 'admin.userjobs.buttons.actions')
	...
	public function query() {
		return UserJob::query()->with(['occupation_id', 'specialtie_id', 'user_id'])->select("user_jobs.*");
	...
	public function html() {
		...
		//->ajax('')
            ...
            ".filterElement('2', 'select', \App\Models\Occupation::pluck("occupation_name_ar", "occupation_name_ar"))."

            ".filterElement('3', 'select', \App\Models\Specialtie::pluck("specialty_name_ar", "specialty_name_ar"))."
	...
	protected function getColumns() {
		return [
			...
			[
				'name'  => 'specialtie_id.specialty_name_ar',
				'data'  => 'specialtie_id.specialty_name_ar',
