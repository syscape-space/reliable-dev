...
class SpecialtiesDataTable extends DataTable
{
    ...
    public function dataTable(DataTables $dataTables, $query)
    {
        return datatables($query)
            ->addColumn('actions', 'admin.specialties.buttons.actions')
    ...
    {
        return Specialtie::query()->with(['occupation_id',])->select("specialties.*");
    	...
    	public function html()
	    {
	      $html =  $this->builder()
            ...
            ". filterElement('1,2,3', 'input') . "
                        ...
                        //occupation_idspecialty_name_ar,specialty_name_en,occupation_id4
            ". filterElement('4', 'select', \App\Models\Occupation::pluck("occupation_name_ar","occupation_name_ar")) . "
...
[
				...
				[
                 'name'=>'specialty_name_ar',
                 'data'=>'specialty_name_ar',
                 'title'=>trans('admin.specialty_name_ar'),
		    ],
				[
                 'name'=>'specialty_name_en',
                 'data'=>'specialty_name_en',
                 'title'=>trans('admin.specialty_name_en'),
		    ],
				[
