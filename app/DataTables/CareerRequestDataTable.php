...
class CareerRequestDataTable extends DataTable
{
    ...
    {
        return CareerRequest::query()->select("careers_requests.*");
	...
	public function html()
	{
	    ...
	    protected function getColumns()
	    {
			...
			[
				...
				[
					'name'=>'careerrequests.name',
					'data'=>'name',
					'title'=>trans('admin.name'),
				],
				[
					'name'=>'careerrequests.email',
					'data'=>'email',
