...
            ->addColumn('country_flag', '{!! view("admin.show_image",["image"=>$country_flag])->render() !!}')
            ->addColumn('country_status', '{{ trans("admin.".$country_status) }}')
   		->addColumn('created_at', '{{ date("Y-m-d H:i:s",strtotime($created_at)) }}')   		->addColumn('updated_at', '{{ date("Y-m-d H:i:s",strtotime($updated_at)) }}')            ->addColumn('checkbox', '<div  class="icheck-danger">
                  <input type="checkbox" class="selected_data" name="selected_data[]" id="selectdata{{ $id }}" value="{{ $id }}" >
                  <label for="selectdata{{ $id }}"></label>
                </div>')
            ->rawColumns(['checkbox','actions',"country_flag",]);
    }
    	...
    	public function html()
	    {
	      $html =  $this->builder()
            ...
            ". filterElement('1,2,3,4,5', 'input') . "
                        ...
                        //country_statuscountry_name_ar,country_name_en,country_key,country_iso,country_flag,country_status7
...
[
				...
				[
                 'name'=>'country_key',
                 'data'=>'country_key',
                 'title'=>trans('admin.country_key'),
		    ],
				[
                 'name'=>'country_iso',
                 'data'=>'country_iso',
                 'title'=>trans('admin.country_iso'),
		    ],
				[
                 'name'=>'country_flag',
                 'data'=>'country_flag',
				...
				[
                 'name'=>'countries.country_status',
                 'data'=>'country_status',
                 'title'=>trans('admin.country_status'),
		    ],
            [
	                'name' => 'created_at',
	                'data' => 'created_at',
