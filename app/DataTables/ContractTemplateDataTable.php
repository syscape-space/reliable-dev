...
class ContractTemplateDataTable extends DataTable
{
    ...
    public function dataTable(DataTables $dataTables, $query)
    {
        return datatables($query)
            ->addColumn('actions', 'admin.contract-template.buttons.actions')
    ...
    {
        return ContractTemplate::query()->select("*");
