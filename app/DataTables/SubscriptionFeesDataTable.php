...
class SubscriptionFeesDataTable extends DataTable {
	...
	public function dataTable(DataTables $dataTables, $query) {
		return datatables($query)
			->addColumn('actions', 'admin.subscriptionfees.buttons.actions')
			->addColumn('payment_method', '{{ trans("admin.".$payment_method) }}')
			->addColumn('payment_status', '{{ trans("admin.".$payment_status) }}')
	...
	public function query() {
		return SubscriptionFee::query()->with(['user_id'])->select("subscription_fees.*");
	...
	public function html() {
		...
		//->ajax('')
            ...
            ".filterElement('4', 'select', [
						'electronic_payment' => trans('admin.electronic_payment'),
	...
	protected function getColumns() {
		return [
			...
			[
				'name'  => 'subscription_fees.payment_method',
				'data'  => 'payment_method',
				'title' => trans('admin.payment_method'),
			],
			[
				'name'  => 'subscription_fees.payment_status',
				'data'  => 'payment_status',
				'title' => trans('admin.payment_status'),
			],
