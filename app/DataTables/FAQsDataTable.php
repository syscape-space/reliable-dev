...
class FAQsDataTable extends DataTable {
	...
	public function dataTable(DataTables $dataTables, $query) {
		return datatables($query)
			->addColumn('actions', 'admin.faqs.buttons.actions')
			->addColumn('show_to', '{{ trans("admin.".$show_to) }}')
			->addColumn('question_status', '{{ trans("admin.".$question_status) }}')
	...
	public function query() {
		return FAQ::query()->select("f_a_qs.*");
	...
	protected function getColumns() {
		return [
			...
			[
				'name'  => 'f_a_qs.show_to',
				'data'  => 'show_to',
				'title' => trans('admin.show_to'),
			],
			[
				'name'  => 'f_a_qs.question_status',
				'data'  => 'question_status',
				'title' => trans('admin.question_status'),
			],
			[
				'name'       => 'created_at',
				'data'       => 'created_at',
