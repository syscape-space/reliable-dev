...
class SystemMessagesDataTable extends DataTable
{
    ...
    public function dataTable(DataTables $dataTables, $query)
    {
        return datatables($query)
            ->addColumn('actions', 'admin.systemmessages.buttons.actions')
            ->addColumn('special_for', '{{ trans("admin.".$special_for) }}')
    ...
    {
        return SystemMessage::query()->select("system_messages.*");
...
[
				...
				[
                 'name'=>'system_messages.special_for',
                 'data'=>'special_for',
                 'title'=>trans('admin.special_for'),
		    ],
				[
                 'name'=>'message_ar',
                 'data'=>'message_ar',
