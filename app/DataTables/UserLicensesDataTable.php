...
class UserLicensesDataTable extends DataTable {
	...
	public function dataTable(DataTables $dataTables, $query) {
		return datatables($query)
			->addColumn('actions', 'admin.userlicenses.buttons.actions')
			->addColumn('license_file', '{!! view("admin.show_image",["image"=>$license_file])->render() !!}')
			->addColumn('created_at', '{{ date("Y-m-d H:i:s",strtotime($created_at)) }}')	->addColumn('updated_at', '{{ date("Y-m-d H:i:s",strtotime($updated_at)) }}')	->addColumn('checkbox', '<div  class="icheck-danger">
                  <input type="checkbox" class="selected_data" name="selected_data[]" id="selectdata{{ $id }}" value="{{ $id }}" >
                  <label for="selectdata{{ $id }}"></label>
                </div>')
			->rawColumns(['checkbox', 'actions', "license_file"]);
	}
	...
	public function query() {
		return UserLicense::query()->with(['user_id',
				'user_job_id',
				'occupation_id',
				'specialtie_id'])->select("user_licenses.*");
	...
	protected function getColumns() {
		return [
			...
			[
				'name'  => 'license_name',
				'data'  => 'license_name',
				'title' => trans('admin.license_name'),
			],
			[
				'name'  => 'license_file',
				'data'  => 'license_file',
				'title' => trans('admin.license_file'),
			],
			[
				'name'  => 'user_id.name',
				'data'  => 'user_id.name',
			...
			[
				'name'  => 'license_end_at',
				'data'  => 'license_end_at',
				'title' => trans('admin.license_end_at'),
			],
			[
				'name'  => 'user_job_id.id',
				'data'  => 'user_job_id.id',
