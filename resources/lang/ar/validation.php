...
return [
	...
	|
	 */
	// User Validation Orders And Offers //
	'OrderHadApprovedOffer' => 'لا يمكن قبول  هذا العرض لان هناك عرض سابق تم الموافقة عليه قم بتغيير العرض السابق لتوافق  هذا العرض',
	'UserHaveBalance'       => 'هذا المبلغ لا يتوفر فى محفظة المستخدم رجاء شحن الرصيد',
	'UserHadOrder'          => 'هذا :attribute غير مملوك للمستخدم',
	// User Validation Orders And Offers End //
