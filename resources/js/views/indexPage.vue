    ...
    <div class="container mt-2 pb-5">
      ...
      <div class="logo mt-4 d-md-flex align-items-center">
        <div class="mt-3 pt-5">
          <a href="#">
            <img
              :src="base_url + 'assets/images/images/logo.svg'"
              alt=""
              srcset=""
            />
          </a>
        ...
        <div
          ...
          class="mx-auto carousel mt-4 mt-md-0 slide"
        ...
        >
            ...
            <div class="carousel-item active">
              <div>
                <div class="d-flex align-items-center mb-1">
                  <span class="metr">
                    <img
                      :src="base_url + 'assets/images/images/a-1.png'"
                      alt=""
                    />
                  </span>
                  <h6 style="color: #0091ea; font-size: 16px">
                    البحث عن محامي
                  </h6>
                </div>
                <p class="mb-0" style="font-size: 12px; color: #606572">
            ...
            <div class="carousel-item">
              <div>
                <div class="d-flex align-items-center mb-1">
                  <span class="metr">
                    <img
                      :src="base_url + 'assets/images/images/a-2.png'"
                      alt=""
                    />
                  </span>
                  <h6 style="color: #0091ea; font-size: 16px">
            ...
            <div class="carousel-item">
              <div>
                <div class="d-flex align-items-center mb-1">
                  <span class="metr">
                    <img
                      :src="base_url + 'assets/images/images/a-3.png'"
                      alt=""
                    />
                  </span>
                  <h6 style="color: #0091ea; font-size: 16px">
            ...
            <div class="carousel-item">
              <div>
                <div class="d-flex align-items-center mb-1">
                  <span class="metr">
                    <img
                      :src="base_url + 'assets/images/images/a-4.png'"
                      alt=""
                    />
                  </span>
                  <h6 style="color: #0091ea; font-size: 16px">
            ...
            <div class="carousel-item">
              <div>
                <div class="d-flex align-items-center mb-1">
                  <span class="metr">
                    <img
                      :src="base_url + 'assets/images/images/a-5.png'"
                      alt=""
                    />
                  </span>
                  <h6 style="color: #0091ea; font-size: 16px">
            ...
            <div class="carousel-item">
              <div>
                <div class="d-flex align-items-center mb-1">
                  <span class="metr">
                    <img
                      :src="base_url + 'assets/images/images/a-6.png'"
                      alt=""
                    />
                  </span>
                  <h6 style="color: #0091ea; font-size: 16px">
            ...
            <div class="carousel-item">
              <div>
                <div class="d-flex align-items-center mb-1">
                  <span class="metr">
                    <img
                      :src="base_url + 'assets/images/images/a-7.png'"
                      alt=""
                    />
                  </span>
                  <h6 style="color: #0091ea; font-size: 16px">
          ...
          <button
            class="bg-transparent border-0 carousel-control-prev"
            type="button"
            data-bs-target="#carouselExampleIndicators"
            data-bs-slide="prev"
          >
          ...
          <button
            class="bg-transparent border-0 carousel-control-next"
            type="button"
            data-bs-target="#carouselExampleIndicators"
            data-bs-slide="next"
          >
      ...
      <div class="container login">
        <div class="content-login d-md-flex justify-content-between pt-4">
          <div class="d-flex align-items-start mt-5 mt-md-0">
  ...
  >
    <div class="modal-dialog">
      <div class="modal-content" style="align-items: flex-start">
        <img
          class="mx-5"
          style="opacity: 0.2; width: 82px; margin-top: 42px"
          :src="base_url + 'assets/images/images/single-logo.svg'"
          alt=""
        />
        <div>
          <div class="modal-header border-0">
            <h5
              ...
              style="font-size: 39px; color: #048e81; font-weight: 300"
            >
              من نحن
            </h5>
            <button
  ...
  <section style="color: #4e5567">
    <div class="container">
      ...
      <div class="text-center">
        <img
          class="ital"
          :src="base_url + 'assets/images/images/italic.svg'"
          alt=""
        />
      </div>
      <div
        style="max-width: 967px; margin: 23px auto"
        class="position-relative"
      >
        <img
          class="abs-img h-100"
          :src="base_url + 'assets/images/images/dots.svg'"
          alt=""
        />
        <div class="btns-bb">
          ...
          <div class="position-relative">
            <img
              class="d-inline-block mt-3 share-btns"
              style="width: 52px; cursor: pointer"
              :src="base_url + 'assets/images/images/share.svg'"
              alt=""
            />
        ...
        <div class="mb-5 rr" id="create">
          <div class="d-inline-block mgmg">
            <div class="d-flex align-items-center mb-2">
              ...
              <img
                class="dots-blue mx-1"
                :src="base_url + 'assets/images/images/doted.svg'"
                alt=""
              />
            </div>
            <div>
      ...
      <div class="row w-100 mx-0 px-0">
        ...
        <div class="col-lg-3">
          <div style="color: #048e81" class="f-18">
            <img :src="base_url + 'assets/images/images/logo.svg'" alt="" />
          </div>
        </div>
      </div>
    </div>
