          ...
          <div class="col-12 col-md-4 mb-5">
            <div class="card user-card user-card-1" style="font-size: 14px;">
                ...
                <div class="d-flex pt-3 mb-2 justify-content-center align-items-start">
                  <div>
                    <img
                        ...
                        style="width: 55px; height: 55px !important; border-radius: 50%; margin: auto;">
                  </div>
              ...
              <ul class="list-group list-group-flush px-0 border-0 mb-3 text-center">
                ...
                <button class="btn mt-2" v-if="$root.auth_user.current_subscription"
                        style="border: 0px;background-color: rgb(255 202 148); color: rgb(0 0 0);;font-size: 11px;width: 90%;margin: auto;">
                  مشترك في
                  {{$root.auth_user.current_subscription.package.package_title}}
                </button>
                <button class="btn mt-2" v-else
                        style="border: 0px;background-color: rgb(255 202 148); color: rgb(0 0 0);;font-size: 11px;width: 90%;margin: auto;">
                  غير مشترك
                </button>
              </ul>
              ...
              <ul class="list-group list-group-flush px-0">
                <li class="list-group-item"> <span class="f-w-500"><i class="feather icon-mail m-r-10"></i>بريد
                    الالكتروني </span> <a style="text-decoration:none" href="mailto:{{user?.email}}" class="text-body">
                  {{ user?.email }} </a>
                </li>
              ...
              <div class="nav flex-column nav-pills list-group list-group-flush list-pills" id="user-set-tab"
                ...
                <router-link v-if="$root.auth_user.membership_type === 'vendor'" class="nav-link list-group-item list-group-item-action" :to="{name:'Subscription'}">
                  ...
                  <span class="float-start" v-if="$root.auth_user.current_subscription">
                ...
                <a v-if="user?.membership_type == 'vendor'"
                   ...
                   :class="{active: activeLink == 'commercial'}" @click="activeLink = 'commercial'" href="#"> <span
                    ...
                    <p v-if="commercial_status != 'unset'" class="p-0 m-0"
                       :class="{'text-danger': commercial_status == 'end', 'text-success': commercial_status == 'active', 'text-white': activeLink == 'commercial'}"
                       v-text="commercial_status == 'active' ? 'نشيط' : 'منتهي'"></p>
                ...
                <a v-if="user?.membership_type != 'user'"
                  ...
                  <span class="float-start">
                    ...
                    <p v-if="license_status != 'unset'" class="p-0 m-0"
                       :class="{'text-danger': license_status == 'end', 'text-success': license_status == 'active', 'text-white': activeLink == 'license'}"
                       v-text="license_status == 'active' ? 'نشيط' : 'منتهي'"></p>
