                    ...
                    <li class="mb-3 mt-4 text-center">
                      <div class="text-center mb-2">
                        <img
                          ...
                          class="uses-img"
                          :src="base_url + '/assets/assets/images/user.svg'"
                          alt=""
                        />
                      </div>
                ...
                <div class="discuss-deal mt-4">
                  ...
                  <div class="notes-discuss my-3 me-3 d-flex">
                    <div class="btn-discuss position-relative">
                      ...
                      :src="base_url + '/assets/assets/images/discuss.svg'" alt="" srcset="">
                    </div>
                    <div class="btn-discuss position-relative">
                      <button
                      ...
                      transform: translate(-50%, -50%);
                      position: absolute;"
                      :src="base_url + '/assets/assets/images/notes.svg'" alt="" srcset="">
                    </div>
                    
                  </div>
                  <div class="comments position-relative">
                    <p><span class="ms-3"> {{ $root._t("app.time") }} </span> {{ $root._t("app.howAreU") }} </p>
                    <img :src="base_url + '/assets/assets/images/comment1_1.png'" alt="">
                  </div>
                  <div class="comments position-relative">
                    <p><span class="ms-3"> {{ $root._t("app.time") }} </span> {{ $root._t("app.howAreU") }} </p>
                    <img :src="base_url + '/assets/assets/images/comment1_2.png'" alt="">
                  </div>
                  <div class="comments position-relative">
                    <p><span class="ms-3"> {{ $root._t("app.time") }} </span>  {{ $root._t("app.howAreU") }}  </p>
                    <img :src="base_url + '/assets/assets/images/comment1_1.png'" alt="">
                ...
                <div 
                  ...
                  <div class="d-flex align-items-center w-100 p-2  ">
                    <span style="display: inline-block; padding-left: 8px; border-left: 2px solid #ddd;">
                      <img :src="base_url + '/assets/assets/images/file.png'" alt="">
                    </span>
                    <span class="flex-grow-1" >
                      <input type="text" placeholder=".....اكتب تعليقك هنا" class="form-control bg-transparent border-0">
                    </span>
                    <span>
                      <img :src="base_url + '/assets/assets/images/Frame2.png'" alt="">
                    </span>
                    <span>
                      <button class="bg-transparent border-0">
                        <img :src="base_url + '/assets/assets/images/telegram.png'" alt="">
                      </button>
                    </span>
                  </div>
                </div>
              ...
              <div>
                ...
                >
                  ...
                  <ul class="list-unstyled px-0 f-12 text-end mt-4">
                    ...
                    <li class="mb-3 f-12">
                      <span>{{ $root._t("app.projectOwner") }}</span>
                      <button
                        class="o_btn d-inline-block px-3 py-2 rounded"
                ...
                >
                  <div class="recive-report position-relative">
                    ...
                    >
                    <img
                    :src="base_url + '/assets/assets/images/contract.svg'"
                    alt=""
                    srcset=""
                  /> <br>
                  ...
                  <div class="recive-report position-relative">
                    ...
                    >
                    <img
                    :src="base_url + '/assets/assets/images/recive.svg'"
                    alt=""
                    srcset=""
                  />
                    <br>
                  ...
                  <div class="recive-report position-relative">
                    ...
                    >
                    <img
                      :src="base_url + '/assets/assets/images/report.svg'"
                      alt=""
                      srcset=""
                    /> <br>
                     {{ $root._t("app.report") }}
                ...
                <div
                    class="bg-users f-14 p-3 mt-3 text-center"
                    style="
                      background-image: linear-gradient(
                        to bottom,
                        #ff584d20,
