            ...
            <div class="col-lg-6">
              <div class="row w-100 mx-0 px-0">
                ...
                <span>{{ $root._t("app.home") }} /
                  ...
                  {{ list.department_name_ar }} / <small class="text-danger"> {{ list.order_title }} </small>  </span>
              ...
              <div>
                <h5 class="fw-bold mb-2 g-color border p-2"> {{ $root._t("app.projectDetails") }} </h5>
                <p class=" border p-2" style="font-size: 12px" v-html=" list.order_content ">
                  
                </p>
               
                <div class="discuss-deal mt-4  border p-2">
