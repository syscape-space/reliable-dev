	...
	<div class="card-header">
		...
		<div class="">
			...
			<div class="dropdown-menu" role="menu">
				...
				<a class="dropdown-item"  style="color:#343a40" href="{{aurl('vendorpackages/'.$vendorpackages->id.'/edit')}}">
	...
	<div class="card-body">
		<div class="row">
			<div class="col-md-12 col-lg-12 col-xs-12">
				<b>{{trans('admin.id')}} :</b> {{$vendorpackages->id}}
			</div>
			...
			<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
				<b>{{trans('admin.duration_package_days')}} :</b>
				{!! $vendorpackages->duration_package_days !!}
			</div>
			<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
				<b>{{trans('admin.package_end_at')}} :</b>
				{!! $vendorpackages->package_end_at !!}
			</div>
			<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
