...
<div class="card card-dark">
	...
	<div class="card-body">
		<div class="row">
			...
			<hr />
			@if(!empty($pages->admin_id()->first()))
			<div class="col-lg-12 col-sm-12 col-md-12 col-xs-12">
				<b>{{trans('admin.admin_id')}} :</b>
				{{ $pages->admin_id()->first()->name }}
			</div>
			@endif
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
				<b>{{trans('admin.page_name_ar')}} :</b>
				{!! $pages->page_name_ar !!}
			</div>
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
				<b>{{trans('admin.page_content_ar')}} :</b>
				{!! $pages->page_content_ar !!}
			</div>
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
				<b>{{trans('admin.page_name_en')}} :</b>
				{!! $pages->page_name_en !!}
			</div>
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
				<b>{{trans('admin.page_content_en')}} :</b>
				{!! $pages->page_content_en !!}
			</div>
