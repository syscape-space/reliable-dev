...
@if (admin()->user()->role('countries_show') ||
    admin()->user()->role('pages_show') ||
    admin()->user()->role('socials_show') ||
    admin()->user()->role('cities_show') ||
    admin()->user()->role('settings_show') ||
    admin()->user()->role('occupations_show') ||
    admin()->user()->role('specialties_show') ||
    admin()->user()->role('systemmessages_show'))
    @if (admin()->user()->role('admins_show'))
        <li
            class="nav-item {{ active_link('settings|ordertypes|countries|pages|socials|cities|occupations|specialties|systemmessages','menu-open') }} ">
            <a href="#"
                class="nav-link {{ active_link('settings|ordertypes|countries|pages|socials|cities|occupations|specialties|systemmessages','active') }}">
                ...
                @if (admin()->user()->role('settings_show'))
                    <li class="nav-item">
                        <a href="{{ aurl('settings') }}"
                            class="nav-link  {{ empty(request('type')) ? active_link('settings', 'active') : '' }}">
                            <i class="fa fa-tachometer-alt nav-icon"></i>
                            <p>{{ trans('admin.home_settings') }} </p>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="{{ aurl('settings') }}?type=account_settings"
                            class="nav-link
        ...
        ">
                    ...
                    <li class="nav-item">
                        <a href="{{ aurl('settings') }}?type=subscription_fee_settings"
                            class="nav-link
        ...
        ">
                    ...
                    <li class="nav-item">
                        <a href="{{ aurl('settings') }}?type=orders_settings"
                            class="nav-link
        ...
        ">
                    ...
                    <li class="nav-item">
                        <a href="{{ aurl('settings') }}?type=reviews_settings"
                            class="nav-link
        ...
        ">
                    ...
                    <li class="nav-item">
                        <a href="{{ aurl('settings') }}?type=terms_and_conditions_settings"
                            class="nav-link
        ...
        ">
                    ...
                    <li class="nav-item">
                        <a href="{{ aurl('settings') }}?type=iam_settings"
                            class="nav-link
        ...
        ">
                    ...
                    <li class="nav-item">
                        <a href="{{ aurl('settings') }}?type=sms_settings"
                            class="nav-link
        ...
        ">
                ...
                @if (admin()->user()->role('systemmessages_show'))
                    <li class="nav-item {{ active_link('systemmessages', 'menu-open') }} ">
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="{{ aurl('systemmessages') }}"
                                    class="nav-link  {{ active_link('systemmessages', 'active') }}">
                ...
                @if (admin()->user()->role('orderarbitrators_show'))
                    <li class="nav-item {{ active_link('orderarbitrators', 'menu-open') }} ">
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="{{ aurl('orderarbitrators') }}"
                                    class="nav-link  {{ active_link('orderarbitrators', 'active') }}">
                ...
                @if (admin()->user()->role('occupations_show'))
                    <li class="nav-item {{ active_link('occupations', 'menu-open') }} ">
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="{{ aurl('occupations') }}"
                                    class="nav-link  {{ active_link('occupations', 'active') }}">
                ...
                @if (admin()->user()->role('specialties_show'))
                    <li class="nav-item {{ active_link('specialties', 'menu-open') }} ">
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="{{ aurl('specialties') }}"
                                    class="nav-link  {{ active_link('specialties', 'active') }}">
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="{{ aurl('countries') }}"
                                    class="nav-link  {{ active_link('countries', 'active') }}">
                ...
                @if (admin()->user()->role('cities_show'))
                    <li class="nav-item {{ active_link('cities', 'menu-open') }} ">
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="{{ aurl('cities') }}"
                                    class="nav-link  {{ active_link('cities', 'active') }}">
                ...
                @if (admin()->user()->role('socials_show'))
                    <li class="nav-item {{ active_link('socials', 'menu-open') }} ">
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="{{ aurl('socials') }}"
                                    class="nav-link  {{ active_link('socials', 'active') }}">
                ...
                @if (admin()->user()->role('ordertypes_show'))
                    <li class="nav-item {{ active_link('ordertypes', 'menu-open') }} ">
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="{{ aurl('ordertypes') }}"
                                    class="nav-link  {{ active_link('ordertypes', 'active') }}">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="{{ aurl('admingroups') }}"
                                class="nav-link {{ active_link('admingroups', 'active') }}">
                                <i class="fas fa-users nav-icon"></i>
    ...
    <li class="nav-item {{ active_link('users', 'menu-open') }} ">
        ...
        <ul class="nav nav-treeview">
            <li class="nav-item  {{ in_array(request('membership_type'), ['vendor', 'employee']) ? 'menu-open' : '' }} ">
                <a href="#"
                    class="nav-link {{ in_array(request('membership_type'), ['vendor', 'employee']) ? 'active' : '' }}">
                    <i class="nav-icon fa fa-users"></i>
                    <p>
                        المحكمين
                        <i class="right fas fa-angle-left"></i>
                ...
                <ul class="nav nav-treeview">
                    <li class="nav-item">
                        <a href="{{ aurl('users') }}?membership_type=judger"
                            class="nav-link  {{ request('membership_type') == 'judger' && empty(request('account_type')) ? 'active' : '' }}">
                            <i class="fa fa-users nav-icon"></i>
                            <p>{{ trans('admin.all') }} </p>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="{{ aurl('users/create') }}?membership_type=judger"
                            class="nav-link {{ request('membership_type') == 'judger' ? 'active' : '' }}">
                            <i class="fas fa-plus nav-icon"></i>
                            <p>اضافة محكم </p>
                        </a>
                    </li>
            ...
            <li class="nav-item  {{ in_array(request('membership_type'), ['vendor', 'employee']) ? 'menu-open' : '' }} ">
                ...
                <ul class="nav nav-treeview">
                    <li class="nav-item">
                        <a href="{{ aurl('users') }}?membership_type=vendor"
                            class="nav-link  {{ request('membership_type') == 'vendor' && empty(request('account_type')) ? 'active' : '' }}">
                            <i class="fa fa-users nav-icon"></i>
                            <p>{{ trans('admin.all') }} </p>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="{{ aurl('users') }}?membership_type=vendor&account_type=company"
                            class="nav-link  {{ request('membership_type') == 'vendor' && request('account_type') == 'company' ? 'active' : '' }}">
                            <i class="fa fa-users nav-icon"></i>
                            <p>{{ trans('admin.company') }} </p>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="{{ aurl('users') }}?membership_type=vendor&account_type=individual"
                            class="nav-link  {{ request('membership_type') == 'vendor' && request('account_type') == 'individual' ? 'active' : '' }}">
                            <i class="fa fa-users nav-icon"></i>
                            <p>{{ trans('admin.individual') }} </p>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="{{ aurl('users') }}?membership_type=employee&account_type=individual"
                            class="nav-link {{ request('membership_type') == 'employee' && request('account_type') == 'individual' ? 'active' : '' }}">
                            <i class="fa fa-users nav-icon"></i>
                            <p>{{ trans('admin.employee') }} </p>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="{{ aurl('users/create') }}?membership_type=employee"
                            class="nav-link {{ request('membership_type') == 'employee' ? 'active' : '' }}">
                            <i class="fas fa-plus nav-icon"></i>
                            <p>{{ trans('admin.add_employee') }} </p>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="{{ aurl('users/create') }}?membership_type=vendor"
                            class="nav-link {{ request('membership_type') == 'vendor' ? 'active' : '' }}">
                            <i class="fas fa-plus nav-icon"></i>
            ...
            <li class="nav-item  {{ in_array(request('membership_type'), ['user']) ? 'menu-open' : '' }} ">
                ...
                <ul class="nav nav-treeview">
                    <li class="nav-item">
                        <a href="{{ aurl('users') }}?membership_type=user"
                            class="nav-link  {{ request('membership_type') == 'user' && empty(request('account_type')) ? 'active' : '' }}">
                            <i class="fa fa-users nav-icon"></i>
                            <p>{{ trans('admin.all') }} </p>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="{{ aurl('users') }}?membership_type=user&account_type=company"
                            class="nav-link  {{ request('membership_type') == 'user' && request('account_type') == 'company' ? 'active' : '' }}">
                            <i class="fa fa-users nav-icon"></i>
                            <p>{{ trans('admin.company') }} </p>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="{{ aurl('users') }}?membership_type=user&account_type=individual"
                            class="nav-link  {{ request('membership_type') == 'user' && request('account_type') == 'individual' ? 'active' : '' }}">
                            <i class="fa fa-users nav-icon"></i>
                            <p>{{ trans('admin.individual') }} </p>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="{{ aurl('users/create') }}?membership_type=user"
                            class="nav-link {{ request()->segment(3) == 'create' && request('membership_type') == 'user' ? 'active' : '' }}">
                            <i class="fas fa-plus nav-icon"></i>
...
@if (admin()->user()->role('orders_show') ||
    admin()->user()->role('orderarbitratorinvoices_show') ||
    admin()->user()->role('orderarbitrators_show') ||
    admin()->user()->role('orderofferinvoices_show') ||
    admin()->user()->role('orderoffers_show'))
    <li
        class="nav-item {{ active_link('orders|orderarbitratorinvoices|orderarbitrators|orderofferinvoices|orderoffers', 'menu-open') }} ">
        <a href="#"
            class="nav-link {{ active_link('orders|orderarbitratorinvoices|orderarbitrators|orderofferinvoices|orderoffers', 'active') }}">
            <i class="nav-icon fa fa-luggage-cart"></i>
            <p>
                {{ trans('admin.orders') }}
                <span style="position:relative;font-size: 14px;"
                    class="badge badge-warning navbar-badge">{{ App\Models\Order::where('order_status', 'under_review')->count() }}</span>
                <i class="right fas fa-angle-left"></i>
            </p>
        </a>
        <ul class="nav nav-treeview">
            ...
            @if (admin()->user()->role('orderoffers_show'))
                <li class="nav-item {{ active_link('orderoffers', 'menu-open') }} ">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="{{ aurl('orderoffers') }}"
                                class="nav-link  {{ active_link('orderoffers', 'active') }}">
            ...
            @if (admin()->user()->role('orderofferinvoices_show'))
                <li class="nav-item {{ active_link('orderofferinvoices', 'menu-open') }} ">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="{{ aurl('orderofferinvoices') }}"
                                class="nav-link  {{ active_link('orderofferinvoices', 'active') }}">
          ...
          <a href="{{ aurl('orderofferinvoices/create') }}" class="nav-link">
            ...
            @if (admin()->user()->role('orderarbitratorinvoices_show'))
                <li class="nav-item {{ active_link('orderarbitratorinvoices', 'menu-open') }} ">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="{{ aurl('orderarbitratorinvoices') }}"
                                class="nav-link  {{ active_link('orderarbitratorinvoices', 'active') }}">
                                <i class="fa fa-file-invoice nav-icon"></i>
    ...
    <ul class="nav nav-treeview">
        @if (admin()->user()->role('subscriptionfees_show'))
            <li class="nav-item {{ active_link('subscriptionfees', 'menu-open') }} ">
                ...
                <ul class="nav nav-treeview">
                    <li class="nav-item">
                        <a href="{{ aurl('subscriptionfees') }}"
                            class="nav-link  {{ active_link('subscriptionfees', 'active') }}">
    ...
    <ul class="nav nav-treeview">
        ...
        @if (admin()->user()->role('balancerecharges_show'))
            <li class="nav-item {{ active_link('balancerecharges', 'menu-open') }} ">
                ...
                <ul class="nav nav-treeview">
                    <li class="nav-item">
                        <a href="{{ aurl('balancerecharges') }}"
                            class="nav-link  {{ active_link('balancerecharges', 'active') }}">
        ...
        @if (admin()->user()->role('balancewithdrawals_show'))
            <li class="nav-item {{ active_link('balancewithdrawals', 'menu-open') }} ">
                ...
                <ul class="nav nav-treeview">
                    <li class="nav-item">
                        <a href="{{ aurl('balancewithdrawals') }}"
                            class="nav-link  {{ active_link('balancewithdrawals', 'active') }}">
...
<li class="nav-item {{ active_link('balancerecharges', 'menu-open') }} ">
    <a href="#" class="nav-link {{ active_link('balancerecharges', 'active') }}">
        ...
        <p>
            ...
            <span>
                خدمات الموقع
                <span style="position:relative;font-size: 14px;" class="badge badge-warning navbar-badge">15</span>
            </span>
            <i class="right fas fa-angle-left"></i>
        </p>
    </a>
    <ul class="nav nav-treeview">
        <li class="nav-item {{ active_link('careers', 'menu-open') }} ">
            ...
            <ul class="nav nav-treeview">
                ...
                <li class="nav-item">
                    <a href="{{ aurl('careerrequests') }}"
                        class="nav-link  {{ active_link('careerrequests', 'active') }}">
                        <i class="fa fa-user-tie nav-icon"></i>
        ...
        @if (admin()->user()->role('vendorpackages_show'))
            <li class="nav-item {{ active_link('vendorpackages', 'menu-open') }} ">
                ...
                <ul class="nav nav-treeview">
                    <li class="nav-item">
                        <a href="{{ aurl('vendorpackages') }}"
                            class="nav-link  {{ active_link('vendorpackages', 'active') }}">
    ...
    admin()->user()->role('userlicenses_show') ||
    admin()->user()->role('userexperiences_show') ||
    admin()->user()->role('userqualifications_show'))
            <li
                class="nav-item {{ active_link('usercommercials|userlicenses|userexperiences|userqualifications', 'menu-open') }} ">
                <a href="#"
                    class="nav-link {{ active_link('usercommercials|userlicenses|userexperiences|userqualifications', 'active') }}">
                    <i class="nav-icon fa fa-house-user"></i>
                    <p>
                ...
                <ul class="nav nav-treeview">
                    ...
                    @if (admin()->user()->role('usercommercials_show'))
                        <li class="nav-item {{ active_link('usercommercials', 'menu-open') }} ">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="{{ aurl('usercommercials') }}"
                                        class="nav-link  {{ active_link('usercommercials', 'active') }}">
                    ...
                    @if (admin()->user()->role('userlicenses_show'))
                        <li class="nav-item {{ active_link('userlicenses', 'menu-open') }} ">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="{{ aurl('userlicenses') }}"
                                        class="nav-link  {{ active_link('userlicenses', 'active') }}">
                    ...
                    @if (admin()->user()->role('userexperiences_show'))
                        <li class="nav-item {{ active_link('userexperiences', 'menu-open') }} ">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="{{ aurl('userexperiences') }}"
                                        class="nav-link  {{ active_link('userexperiences', 'active') }}">
                                        <i class="fa fa-file-alt nav-icon"></i>
                    ...
                    @if (admin()->user()->role('userqualifications_show'))
                        <li class="nav-item {{ active_link('userqualifications', 'menu-open') }} ">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="{{ aurl('userqualifications') }}"
                                        class="nav-link  {{ active_link('userqualifications', 'active') }}">
        ...
        <li class="nav-item {{ active_link('our-services', 'menu-open') }} ">
            ...
            <ul class="nav nav-treeview">
                <li class="nav-item">
                    <a href="{{ aurl('our-services') }}"
                        class="nav-link  {{ active_link('our-services', 'active') }}">
                        <i class="fa fa-user-tie nav-icon"></i>
        ...
        <li class="nav-item {{ active_link('our-services', 'menu-open') }} ">
            ...
            <ul class="nav nav-treeview">
                <li class="nav-item">
                    <a href="{{ aurl('mail-templates') }}"
                        class="nav-link  {{ active_link('mail-templates ', 'active') }}">
                        <i class="fa fa-user-tie nav-icon"></i>
                        <p>قوالب البريد</p>
                    </a>
                </li>
    ...
    <ul class="nav nav-treeview">
        ...
        @if (admin()->user()->role('tickets_show'))
            <li class="nav-item {{ active_link('tickets', 'menu-open') }} ">
                ...
                <ul class="nav nav-treeview">
                    <li class="nav-item">
                        <a href="{{ aurl('instructions') }}" class="nav-link  {{ active_link('tickets', 'active') }}">
                            <i class="fa fa-ticket-alt nav-icon"></i>
                            التعليمات
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="{{ aurl('instructions/create') }}" class="nav-link">
                            <i class="fas fa-plus nav-icon"></i>
                            <p>{{ trans('admin.create') }} </p>
                        </a>
                    </li>
...
<li class="nav-item {{ active_link('tickets', 'menu-open') }} ">
    ...
    <ul class="nav nav-treeview">
        ...
        <li class="nav-item {{ active_link('supportmessages', 'menu-open') }} ">
            ...
            <ul class="nav nav-treeview">
                <li class="nav-item">
                    <a href="{{ aurl('supportmessages') }}"
                        class="nav-link  {{ active_link('supportmessages', 'active') }}">
                        <i class="fa fa-user-tie nav-icon"></i>
        ...
        @if (admin()->user()->role('ticketdepartments_show'))
            <li class="nav-item {{ active_link('ticketdepartments', 'menu-open') }} ">
                ...
                <ul class="nav nav-treeview">
                    <li class="nav-item">
                        <a href="{{ aurl('ticketdepartments') }}"
                            class="nav-link  {{ active_link('ticketdepartments', 'active') }}">
...
@if (admin()->user()->role('packagerequests_show'))
    <li class="nav-item {{ active_link('packagerequests', 'menu-open') }} ">
        ...
        <ul class="nav nav-treeview">
            <li class="nav-item">
                <a href="{{ aurl('packagerequests') }}"
                    class="nav-link  {{ active_link('packagerequests', 'active') }}">
