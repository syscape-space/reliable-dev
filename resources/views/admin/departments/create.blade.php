...
@include("admin.layouts.components.submit_form_ajax",["form"=>"#departments"])
			...
			@foreach($occupation->specialties()->get() as $specialtie)
			 <div class="col-md-4 col-lg-4 col-sm-4 col-xs-12">
			        ...
			        <div class="custom-control custom-switch mt-4">
			            <input type="checkbox" class="custom-control-input checkinput" name="specialtie_id[]" value="{{ $specialtie->id }}" id="specialtie_id{{ $specialtie->id }}">
...
<div class="col-md-6 col-lg-6 col-sm-6 col-xs-12">
	...
	<div class="custom-control custom-switch">
		<input type="checkbox" class="custom-control-input checkinput"
					name="enable_post" {{old('enable_post') == 'yes'?'checked':'' }}
