	...
	<div class="card-header">
		...
		<div class="">
			...
			<div class="dropdown-menu" role="menu">
				<a href="{{ aurl('contactus') }}"  style="color:#343a40"  class="dropdown-item">
...
<div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
    <div class="form-group">
        {!! Form::label('title_msg',trans('admin.title_msg'),['class'=>' control-label']) !!}
            {!! Form::text('title_msg',old('title_msg'),['class'=>'form-control','placeholder'=>trans('admin.title_msg')]) !!}
    </div>
</div>
<div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
    <div class="form-group">
...
<div class="col-md-6 col-lg-6 col-sm-6 col-xs-12">
	<div class="form-group">
		...
		{!! Form::select('seen',['yes'=>trans('admin.yes'),'no'=>trans('admin.no'),],old('seen'),['class'=>'form-control select2','placeholder'=>trans('admin.choose')]) !!}
	</div>
</div>
