...
<div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
    <div class="form-group">
		...
		{!! Form::text('qualification', old('qualification'), ['class'=>'form-control','placeholder' => trans('admin.qualification')]) !!}
	</div>
</div>
<div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
    <div class="form-group">
		{!! Form::label('experience',trans('admin.experience')) !!}
		{!! Form::textarea('experience', old('experience'), ['class'=>'form-control','placeholder' => trans('admin.experience')]) !!}
	</div>
</div>
<div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
    <div class="form-group">
...
<div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
    <div class="form-group">
		...
		{!! Form::date('end_at', old('end_at'), ['class'=>'form-control','placeholder' => trans('admin.end_at')]) !!}
	</div>
</div>
