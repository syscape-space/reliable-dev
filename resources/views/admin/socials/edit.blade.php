...
@include("admin.layouts.components.submit_form_ajax",["form"=>"#socials",'query'=>''])
...
<div class="col-md-6 col-lg-6 col-sm-6 col-xs-12">
    <div class="form-group">
        ...
        {!! Form::text('social_name', $socials->social_name ,['class'=>'form-control','placeholder'=>trans('admin.social_name')]) !!}
    </div>
</div>
<div class="col-md-6 col-lg-6 col-sm-6 col-xs-12">
    <div class="form-group">
        {!! Form::label('social_fa',trans('admin.social_fa'),['class'=>'control-label']) !!}
        {!! Form::text('social_fa', $socials->social_fa ,['class'=>'form-control','placeholder'=>trans('admin.social_fa')]) !!}
    </div>
</div>
...
<div class="col-md-6 col-lg-6 col-sm-6 col-xs-12">
    <div class="form-group">
        ...
        {!! Form::url('social_url', $socials->social_url ,['class'=>'form-control','placeholder'=>trans('admin.social_url')]) !!}
    </div>
</div>
