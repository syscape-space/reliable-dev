        ...
        @endpush
            ...
            <div class="col-md-3 col-lg-3 col-sm-3 col-xs-12">
                <div class="form-group">
                    ...
                    {!! Form::text('email_verify_code',$users->email_verify_code,['class'=>'form-control','placeholder'=>trans('admin.email_verify_code')]) !!}
                </div>
            </div>
            <div class="col-md-3 col-lg-3 col-sm-3 col-xs-12">
                <div class="form-group">
            ...
            <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12">
                <div class="form-group">
                    ...
                    @foreach(\App\Models\Specialtie::all() as $specialty)
                        <div class="row">
                            <div class="col-md-12">
                                <input id="specialties-{{$specialty->id}}" {{$users->specialties->contains($specialty) ? "checked" : ""}} value="{{$specialty->id}}" type="checkbox" name="specialties[]">
            ...
            <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12">
                <div class="form-group">
                    ...
                    @foreach(\App\Models\Occupation::all() as $occupation)
                        <div class="row">
                            <div class="col-md-12">
                                <input id="occupations-{{$occupation->id}}" {{$users->occupations->contains($occupation) ? "checked" : ""}} value="{{$occupation->id}}" type="checkbox" name="occupations[]">
            ...
            <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12 ban  {{ $users->account_status != 'ban'?'hidden':'' }}">
                <div class="form-group">
            ...
            <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12 refused_reason  {{ $users->account_status != 'refused'?'hidden':'' }}">
                <div class="form-group">
            ...
            <div class="col-md-6 col-lg-6 col-sm-6 col-xs-6 disable_adding_offer_reason {{ $users->add_offer == 'enable'?'hidden':'' }}">
                <div class="form-group">
            ...
            <div class="col-md-6 col-lg-6 col-sm-6 col-xs-6 disable_adding_request_reason {{ $users->add_request == 'enable'?'hidden':'' }} ">
                <div class="form-group">
