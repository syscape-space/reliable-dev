        ...
        <div class="row">
            ...
            <div class="col-md-3 col-lg-3 col-sm-3 col-xs-12 photo_profile">
                <div class="form-group">
                    ...
                    <div class="input-group">
                        <div class="custom-file">
                            {!! Form::file('badge_icon', ['class' => 'custom-file-input', 'placeholder' => trans('admin.badge_icon'), 'accept' => it()->acceptedMimeTypes('image'), 'id' => 'badge_icon']) !!}
                            {!! Form::label('badge_icon', trans('admin.badge_icon'), ['class' => 'custom-file-label']) !!}
                        </div>
            ...
            <div class="col-md-4 col-lg-4 col-sm-4 col-xs-12">
                <div class="form-group">
                    {!! Form::label('add_badge', trans('admin.add_badge')) !!}
                    {!! Form::text('add_badge', old('add_badge'), ['class' => 'form-control', 'placeholder' => trans('admin.add_badge')]) !!}

                </div>
            </div>
            <div class="col-md-4 col-lg-4 col-sm-4 col-xs-12">
                <div class="form-group">
                    {!! Form::label('badge_condition', trans('admin.badge_condition')) !!}
                    {!! Form::text('badge_condition', old('badge_condition'), ['class' => 'form-control', 'placeholder' => trans('admin.badge_condition')]) !!}
