	...
	<div class="card-header">
		...
		<div class="">
			...
			<div class="dropdown-menu" role="menu">
				...
				<a class="dropdown-item"  style="color:#343a40" href="{{aurl('userqualifications/'.$userqualifications->id.'/edit')}}">
	...
	<div class="card-body">
		<div class="row">
			<div class="col-md-12 col-lg-12 col-xs-12">
				<b>{{trans('admin.id')}} :</b> {{$userqualifications->id}}
			</div>
			<div class="clearfix"></div>
			<hr />
			<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
				<b>{{trans('admin.qualification_name')}} :</b>
				{!! $userqualifications->qualification_name !!}
			</div>
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
				<b>{{trans('admin.comment')}} :</b>
				{!! $userqualifications->comment !!}
			</div>
			<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
				<b>{{trans('admin.qualification_file')}} :</b>
				<a href="{{ it()->url($userqualifications->qualification_file) }}" target="_blank"><i class="fa fa-file-pdf"></i></a>
			</div>
			<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
				<b>{{trans('admin.user_id')}} :</b>
				@if(!empty($userqualifications->user_id()->first()))
			{{ $userqualifications->user_id()->first()->name }}
			@endif
			</div>
			<!-- /.row -->
		</div>
