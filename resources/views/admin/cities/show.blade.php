...
<div class="card card-dark">
	...
	<div class="card-body">
		<div class="row">
			...
			<hr />
			@if(!empty($cities->admin_id()->first()))
			<div class="col-lg-12 col-sm-12 col-md-12 col-xs-12">
				<b>{{trans('admin.admin_id')}} :</b>
				{{ $cities->admin_id()->first()->name }}
			</div>
			@endif
			<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
				<b>{{trans('admin.city_name_ar')}} :</b>
				{!! $cities->city_name_ar !!}
			</div>
			<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
				<b>{{trans('admin.city_name_en')}} :</b>
				{!! $cities->city_name_en !!}
			</div>
			<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
				<b>{{trans('admin.country_id')}} :</b>
				@if(!empty($cities->country_id()->first()))
			{{ $cities->country_id()->first()->country_name_ar }}
			@endif
			</div>
