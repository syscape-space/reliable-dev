	...
	<div class="card-header">
		...
		<div class="">
			...
			<div class="dropdown-menu" role="menu">
				...
				<a class="dropdown-item"  style="color:#343a40" href="{{aurl('partners/' . $partner->id.'/edit')}}">
	...
	<div class="card-body">
		<div class="row">
			...
			<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
				...
				<a href="{{ $partner->link }}" target="_blank">{{trans('admin.link')}}</a>
			</div>
			<!-- /.row -->
		</div>
	</div>
