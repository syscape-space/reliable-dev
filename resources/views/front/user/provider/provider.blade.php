          ...
          <div class="row w-100 mx-0 px-0">
            <div class="col-lg-9">
              ...
              <div
                ...
                <span><img style="width: 70px;" src="{{asset('assets/images/o_pdf.svg')}}" alt=""></span>
              </div>
                  ...
                  <div class="btw-flex">
                    <div class="position-relative">
                      ...
                      <div style="color: #048E81;" class="add-o-file  f-12">
                        <span>ارفاق ملف</span>
                        <img src="{{asset('assets/images/o_file.svg')}}" alt="">
                      </div>
                    </div>
                    <div>
                      <button style="
                ...
                <div class="btw-flex">
                  <div class="my-2" style="font-size: 12px;">
                    <span class="ms-3">
                      ...
                      style="width: 15px;"
                      class="ms-1"
                      src="{{asset('assets/images/o_clock.svg')}}" alt=""> <span>منذ 4 ساعات</span>
                    </span>
                    <span class="ms-3">
                      <img
                      style="width: 20px;"
                      class="ms-1"
                      src="{{asset('assets/images/o_eye.svg')}}" alt=""> <span>عدد 5 اعمال</span>
                    </span>
                    <span class="ms-3">
                      <img
                      style="width: 14px;"
                      class="ms-1"
                      src="{{asset('assets/images/o_map.svg')}}" alt=""> <span>السعودية</span>
                    </span>
                  </div>
                  <div class="my-2" style="font-size: 12px;">
                    <span class="o-box ms-2">
                      <img
                      style="width: 15px;" class="ms-1" src="{{asset('assets/images/o_delever.svg')}}" alt="">
                      <span>مده التسليم:</span>
                      <span class="me-2">14 يوم</span>
                    </span>
                    <span class="o-box o-box2">
                      <img
                      style="width: 15px;" class="ms-1" src="{{asset('assets/images/o_payment.svg')}}" alt="">
                      <span>:المبلغ:</span>
            ...
            <div class="col-md-3">
                  ...
                  <ul class="list-unstyled px-0 f-12 text-end mt-4">
                    ...
                    <li class="mb-3 mt-4 text-center">
                      <div class="text-center mb-2">
                        <img style="width: 50px;height: 50px;" class="uses-img" src="{{asset('assets/images/user.svg')}}" alt="">
                      </div>
                      <div class="text-center">
              ...
              <div class="div-save p-2 mt-4 ">
                <div class="d-flex align-items-center">
                  <div>
                    <img style="width: 40px;margin-left: 8px;" src="{{asset('assets/images/o_save.svg')}}" alt="">
                  </div>
