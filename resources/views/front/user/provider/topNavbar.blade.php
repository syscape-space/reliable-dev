        ...
        <ul class="list-unstyled d-flex m-0">
          <li class="ms-4 position-relative">
            ...
            href="#"
                ...
                aria-expanded="false"
              ><img src="./images/notification-nav.svg" alt="" srcset="" />
              <span class="red-circle"></span>
            </a>
            <ul class="dropdown-menu rri_o" 
                ...
                <a class="dropdown-item" href="#">
                  <div class="d-flex align-iyems-center o_noti">
                    <div>
                      <img
                        class="ms-3"
                      style="width: 40px;height: 40px;border-radius: 50%;" src="./images/user.svg" alt="">
                    </div>
          ...
          <li class="ms-5 position-relative">
            <a href="#"
              ><img src="./images/nav-message.svg" alt="" srcset="" />
              <span class="red-circle"></span>
            </a>
          </li>
          <li class="d-flex">
