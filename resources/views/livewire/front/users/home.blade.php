...
<body>
    ...
    <header>
        <div class="container mt-2 pb-5">
          <div class="main-lan flex-wrap pt-2 text-start d-flex align-items-center justify-content-center justify-content-md-between">
            ...
            <div class="content-login d-md-flex justify-content-center justify-content-xl-between pt-4">
              <div class=" d-flex gap-3 justify-content-center flex-wrap align-items-start">
                ...
                <div class="box">
                  ...
                  <i class="fa-solid fa-file-pen"></i>                <a href="" class="btn">انشاء طلب جديد  </a>
                </div>
              </div>
      ...
      <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
          <div class="modal-content" style="align-items: flex-start;">
            <img class="mx-5" style="opacity: .2; width: 82px; margin-top: 42px;" src="{{asset('images/single-logo.svg')}}" alt="">
            <div>
          ...
          <div style="max-width: 967px; margin: 23px auto;" class="position-relative">
            ...
            <div class="btns-bb">
              ...
              <div class="position-relative">
                <img class="d-inline-block mt-3 share-btns" style="width: 52px;cursor: pointer;" src="{{asset('images./img')}}" alt="">
        ...
        <div class="container">
          <div class="row w-100 mx-0 px-0">
            ...
            <div class="col-lg-3">
              ...
              <img src="{{asset('images/logo.svg')}}" alt=""></div>
            </div>
          </div>
        </div>
      </footer>
