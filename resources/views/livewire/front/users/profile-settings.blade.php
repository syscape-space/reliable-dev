      ...
      <div class="row">
         ...
         <div class="col-12 back mb-5 d-flex align-items-center justify-content-end">
            <div class="row w-100 justify-content-end">
               <div class="flex-wrap col-xl-8 d-flex align-items-center justify-content-between  gap-sm-4">
         ...
         <div class="col-xl-4 pe-lg-0 r-bar text-center text-xl-end ps-xl-5">
            <div class="row w-100 mx-0 px-0 parent-boxes">
               <div class="col-12 mb-5">
                  <div class="box w-100 box-info">
                     <div class="photo">
               ...
               <div class="col-12 mb-5">
                  <div class="box w-100 text-start  box-data d-flex flex-column">
