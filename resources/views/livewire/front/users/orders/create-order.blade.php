                ...
                <div class="container">
                    <form action="">
                        ...
                        <div class="level-one">
                            ...
                            <input
                                class="sub mx-auto mt-5 d-block"
                                type="submit"
                                value="التالي"
                        ...
                        <div class="level-two">
                            ...
                            <div
                                class="d-flex d-flex flex-wrap flex-xxl-nowrap justify-content-center gap-0"
                            >
                                <div class="num-order text-center fs-4">
                                    رقم الطلب
                                    <div class="count">65421021</div>
                                </div>
                                <div
                                ...
                                >
                                    <ul
                                        class="levels-bar align-items-baseline gap-4 text-center d-flex"
                                    >
                                        <li class="active">
                            ...
                            >
                                ...
                                <input
                                    type="text"
                                    placeholder="رقم الملحق هنا"
                                    name=""
                                    id=""
                                />
                            </div>
                            <input
                                class="sub mt-5 mx-auto d-block"
                                type="submit"
                                value="حفظ ومتابعة"
                            />
                        </div>
                        ...
                        <div class="level-three">
                            ...
                            <div
                                class="d-flex flex-wrap justify-content-center gap-0"
                            >
                                <div class="num-order text-center fs-4">
                                    رقم الطلب
                                    <div class="count">65421021</div>
                            ...
                            <div
                                class="duration mt-4 mb-4 d-flex gap-4 flex-wrap align-items-end"
                            >
                                <div class="inp">
                                    <div class="lable">
                            ...
                            <div
                                class="files d-flex flex-wrap gap-5 align-items-center"
                            >
                                <div>
                            ...
                            <div
                                class="group-btn mt-5 d-flex align-items-center justify-content-center gap-5"
                            >
                                <input
                                    class="back"
                                    type="reset"
                        ...
                        <div class="level-four">
                            ...
                            <select name="" dir="rtl" id="select-city">
                                <option value="1">أختر المدينة</option>
                            </select>
                            <div class="parent-inp">
                                <input
                                    type="text"
                                    placeholder="البحث عن مقدم الخدمة"
                                    name=""
                            ...
                            <div
                                class="group-btn d-flex align-items-center justify-content-center gap-5"
                            >
                                <input
                                    class="back"
                                    type="reset"
                        ...
                        <div class="level-five">
                            ...
                            <div
                                class="d-flex pb-5 flex-wrap justify-content-center gap-0"
                            >
                                <div class="num-order text-center fs-4">
                                    رقم الطلب
                                    <div class="count">65421021</div>
                            ...
                            <div
                                class="row mb-5 mt-5 align-items-center justify-content-sm-between"
                            >
                                <div class="col-xl-5">
                            ...
                            >
                                <div
                                    class="text d-flex align-items-center gap-5"
                                >
                                    رسوم تقديم الطلب:
