    ...
    <div>
        <div class="">
            <div class="wrap text-center mt-4">
                ...
                <div class="mt-5 d-flex justify-content-center"><button class="submit" wire:click="firstStepSubmit"><a href="#"
                            class="" style="color: rgb(255, 255, 255); text-decoration: none;">
                            التالي
                        </a></button></div>
            </div>
        </div>
...
<div class="row w-100 mx-0 px-0">
    <div class="col-md-6 px-0">
        <div class="p-5">
            ...
            <form wire:submit="secondStepSubmit" class="login-form text-center"
                ...
                <div class="auth-login mb-4 text-center position-relative">
                    <input type="number" class="pe-5 form-control" placeholder="رقم الهوية" wire:model="id_number" />
                    <img class="img-lllo" style="width: 20px; position: absolute; right: 10px"
                        src="{{ asset('assets/images/login-user.svg') }}" alt="" />
                </div>
                <div class="auth-login mb-4 text-center position-relative">
                ...
                <div class="social-btn d-flex align-items-center justify-content-between">
                    <button>
                        {{ __('app.facebook') }}
                        <img style="width: 20px" src="{{ asset('assets/images/login-facebook.svg') }}"
                            alt="" />
                    </button>
                    <button>
                        {{ __('app.google') }}
